...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/style/Common-moble.css">
    <link rel="stylesheet" type="text/css" href="<%=basePath%>css/style/iconfont.css">
    <link rel="stylesheet" href="<%=basePath%>css/phone_amend.css">
    <script src="<%=basePath%>js/src/flexible.js"></script>
    <script src="<%=basePath%>js/src/jquery-2.1.1.min.js"></script>
    <script src="<%=basePath%>js/src/jquery.cookie.js"></script>
    <script src="<%=basePath%>js/src/auth.js"></script>
...
<form id="registerForm">
    ...
    <div id="register">
        ...
        <section class="registerPlace">
            ...
            <input type="text" name="openId" value="oDoUJ1T7gX5EzBYgqpI6oqe7j9Ao" class="hidenInput">
                        ...
                        success: function (data) {
                            ...
                            if(data.status==0){
                                ...
                                $('#toBind').click(function(){
                                    window.location.href="./phone_conect.html"
                                })
                                return false;
                            }
